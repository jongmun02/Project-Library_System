...
<nav class="navbar navbar-default">
	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px">
				<form method="post" action="updateReturn.go">

					<h3 style="text-align: center">
						<strong>도서 반납</strong>
					</h3>
					<input type="text" class="form-control" placeholder="반납할 도서번호"
							name="b_num" value = "<%=request.getAttribute("b_num") %>" readonly = "readonly">
