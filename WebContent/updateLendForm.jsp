...
<nav class="navbar navbar-default">
	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px">
				<form method="post" action="updateLend.go">

					<h3 style="text-align: center">
						<strong>도서 대여</strong>
					</h3>
					<input type="text" class="form-control" placeholder="대여할 도서번호"
						name="b_num" value="<%=request.getAttribute("b_num") %>"
						readonly="readonly"> <input type="submit"
						class="btn btn-primary form-control" value="대여"> 
				</form>
				<button class="btn btn-primary form-control" name="back"
					value="뒤로가기" onclick="location.href = 'userBookMgm.go'"
